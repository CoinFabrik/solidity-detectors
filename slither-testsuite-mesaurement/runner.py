...
all_detector_classes = {"OurDetector": OurDetector, "DivisonByZero": DivisionByZero, "UnprotectedSetOwner": UnprotectedSetOwner, "ForOverUnboundedArray": ForOverUnboundedArray} #this is if you want to test it by itself
